...
unit_gun_dealer allowDamage false;
unit_gun_dealer disableAI "MOVE";
...
unit_gun_dealer addAction["Buy Rook 40 ($250)",{ //Buy rook pistol + 1 free mag
    ...
    }else{hint "Are you trying to rip me off, buddy? this gun is worth more then you're carrying.";}
}];
...
unit_gun_dealer addAction["Buy 16 round 9mm ammunition ($50)",{ //buy pistol ammunition
    ...
    }else{hint "Are you trying to rip me off, buddy? This clip is worth more then you're carrying.";}
}];
