unit_gun_dealer addAction["Buy Rook 40",{ //Buy rook pistol + 1 free mag
...
unit_gun_dealer addAction["Buy Rook 40",{ //Buy sting SMG + 1 free mag
...
unit_gun_dealer addAction["Buy 16 round 9mm ammunition",{ //buy pistol ammunition
...
unit_gun_dealer addAction["Buy 16 round 9mm ammunition",{ //buy SMG ammunition
    if (teamMoney>49) then{
        teamMoney = teamMoney - 50;
        hint "Let me grab that for you";
        sleep (1);
